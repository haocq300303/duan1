<?php
    ...
    foreach ($services as $key => $value) {
        foreach ($value as $index => $item) {
            $moneyService += $item['price'];
        }
    }

    $totalMoney = isset($_SESSION['user']) ? $moneyRoom + $moneyService - 5 : $moneyRoom + $moneyService;
    ...
    if(isset($_POST['payment'])) {
            ...
            foreach ($_SESSION['cart'] as $key => $value) {
                ...
                if (is_array($book)) {
                    ...
                    insertBook($name, $phone, $email, $vocher, $dateCheckin, $dateCheckout, $total_price, $status, $value[0]);
                    ...
                    <div class="">
                        <div class="space-x-0 lg:flex lg:space-x-4">
                            <div class="w-full">
                                <label for="firstName" class="block mb-3 text-sm font-semibold text-gray-500">
                                    Name</label>
                                <input
                                        value="<?php echo isset($_SESSION['infoUser']) ? $_SESSION['infoUser'][0][0] : ''; ?>"
                        ...
                        <div class="mt-4">
                            <div class="w-full">
                                ...
                                <input
                                        value="<?php echo isset($_SESSION['infoUser']) ? $_SESSION['infoUser'][0][1] : ''; ?>"
                        ...
                        <div class="mt-4">
                            <div class="w-full">
                                ...
                                <input
                                        value="<?php echo isset($_SESSION['infoUser']) ? $_SESSION['infoUser'][0][2] : ''; ?>"
                        ...
                        <div class="mt-4">
                            <div class="w-full">
                                ...
                                <input
                                        value="<?php echo isset($_SESSION['infoUser']) ? $_SESSION['infoUser'][0][3] : ''; ?>"
                        ...
                        <div class="mt-4">
                            <div class="w-full">
                                ...
                                <input
                                        value="<?php echo isset($_SESSION['infoUser']) ? $_SESSION['infoUser'][0][4] : ''; ?>"
                ...
                <div class="pt-12 md:pt-0 2xl:ps-4">
                    ...
                    ?>
                        <div class="flex items-center w-full py-4 text-sm font-semibold border-b border-gray-300 lg:py-5 lg:px-3 text-heading last:border-b-0 last:text-base last:pb-0">
                            ...
                            ?>:
                            <span class="ml-2">$<?php echo $item['price']; ?></span>
                        </div>
                    <?php }} ?>
                    <div
                        class="flex items-center w-full py-4 text-sm font-semibold border-b border-gray-300 lg:py-5 lg:px-3 text-heading last:border-b-0 last:text-base last:pb-0">
